...
public class FileService : IFileService
{
    ...
    public async Task<DownloadFileResponse> DownloadFileAsync(string fileGid)
    {
        ...
        {
            Key = "images/"  +fileGid, BucketName = BUCKET_NAME, 
        };
        ...
        {
            OutputStream = response.ResponseStream, ContentType = response.Headers.ContentType
        };
    }
    ...
    public async Task<string> UploadFileAsync(string fileGid, IFormFile file)
    {
        ...
        {
            Key = "images/" + fileGidWithExtension, BucketName = BUCKET_NAME, InputStream = file.OpenReadStream(),
            AutoCloseStream = true, ContentType = file.ContentType
        };
        ...
        {
            BucketName = BUCKET_NAME, Key = "images/" + fileGidWithExtension
        });
